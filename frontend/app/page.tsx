...
import { ChevronDown, Menu, X, BarChart3, Clock, Award, ArrowRight, ChevronRight } from "lucide-react"
    ...
    <>
          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              <Link href="/" className="flex items-center">
                ...
                <span className="font-bold text-xl text-white">BeatTheOdds</span>
              </Link>
            </div>
      ...
      <main className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 text-white">
        ...
        <section className="relative pt-32 md:pt-40 pb-20 md:pb-32 px-4 sm:px-6 lg:px-8 overflow-hidden">
          ...
          <motion.div className="max-w-7xl mx-auto relative z-10" initial="hidden" animate="show" variants={container}>
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <motion.div variants={item} className="text-center md:text-left">
                ...
                <p className="text-2xl md:text-3xl font-bold mb-6 text-gray-200">
                  Discover the <span className="text-emerald-400">real chances</span> of winning the jackpot
                </p>
                <p className="text-xl max-w-2xl mx-auto md:mx-0 text-gray-300 mb-8">
                  Our advanced simulation engine runs thousands of virtual bets to show you what gambling companies
                ...
                <div className="flex flex-col sm:flex-row justify-center md:justify-start gap-4 mb-8">
                  <Link href="/dashboard">
                    ...
                    >
                      Start Your Simulation <ArrowRight className="ml-2 h-5 w-5" />
                    </Button>
                  </Link>
                  <Link href="#how-it-works">
                    <Button size="lg" variant="outline" className="border-gray-500 hover:bg-gray-700 text-white">
                      Learn More
                    </Button>
                  </Link>
                </div>
                ...
                <div className="bg-gray-800/50 p-4 rounded-lg inline-block">
                  <p className="text-amber-400 font-semibold flex items-center">
                    <Award className="mr-2 h-5 w-5" /> Over 10,000 simulations run by users like you
                  </p>
                </div>
              </motion.div>
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-full max-w-md bg-gray-800/80 backdrop-blur-sm p-6 rounded-xl border border-gray-700 shadow-2xl">
                      <div className="mb-4 pb-4 border-b border-gray-700">
                        <h3 className="text-lg font-medium text-gray-200">Simulation Results</h3>
                      </div>
                      <div className="space-y-4">
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <span className="text-red-400 font-bold">-$4,880</span>
                        </div>
                        <div className="flex justify-between items-center">
                        ...
                        <div className="w-full bg-gray-700 rounded-full h-2.5 mt-2">
                          <div className="bg-emerald-500 h-2.5 rounded-full" style={{ width: "2.4%" }}></div>
                        </div>
                        <div className="pt-4 mt-4 border-t border-gray-700">
                          <p className="text-amber-400 text-sm">
                            You would need to play for approximately 270 years to have a 50% chance of winning the
                            jackpot.
                          </p>
                        </div>
                      </div>
        ...
        {/* Stats Section */}
        <section id="insights" className="py-16 px-4 sm:px-6 lg:px-8 border-t border-gray-800">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card className="bg-gray-800/60 border-gray-700 hover:border-emerald-500/50 transition-all duration-300 hover:shadow-emerald-500/20 hover:shadow-lg">
                <CardContent className="p-6">
                  <h3 className="text-4xl font-bold text-emerald-400 mb-2">
                    <CountUp end={14000000} prefix="1 in " duration={2.5} separator="," />
                  </h3>
                  <p className="text-gray-300">Average odds of winning a typical lottery jackpot</p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-gray-800/60 border-gray-700 hover:border-emerald-500/50 transition-all duration-300 hover:shadow-emerald-500/20 hover:shadow-lg">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-300">Chance of losing money on jackpot bets over time</p>
                </CardContent>
              </Card>
        ...
        <section id="how-it-works" className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-800/30">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-4xl font-bold mb-16 text-center">How Our Simulation Works</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              <div className="text-center p-6">
                ...
                <p className="text-gray-300">Choose your bet amount, number of tickets, and jackpot type to customize your simulation.</p>
              </div>
              ...
              <div className="text-center p-6">
                ...
                <p className="text-gray-300">Our engine simulates thousands of bets using the same odds as real jackpot games.</p>
              </div>
              ...
              <div className="text-center p-6">
                ...
                <p className="text-gray-300">Get detailed analytics showing your expected returns, losses, and probability of winning.</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-gray-800/60 p-6 rounded-xl border border-gray-700">
                <h3 className="text-xl font-bold mb-3">How accurate are the simulations?</h3>
                <p className="text-gray-300">Our simulations use the exact same odds and payout structures as real jackpot games. The results are statistically accurate representations of what you can expect in real-world gambling scenarios.</p>
              </div>
              
              <div className="bg-gray-800/60 p-6 rounded-xl border border-gray-700">
                <h3 className="text-xl font-bold mb-3">Is this service free to use?</h3>
                <p className="text-gray-300">Yes! Our basic simulation features are completely free. We believe everyone should have access to this information before spending money on gambling.</p>
              </div>
              
              <div className="bg-gray-800/60 p-6 rounded-xl border border-gray-700">
                <h3 className="text-xl font-bold mb-3">Can I simulate specific jackpot games?</h3>
                <p className="text-gray-300">Absolutely. Our platform supports simulations for most popular lottery and jackpot games with their specific rules and odds.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-emerald-900/40 to-blue-900/40">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl font-bold mb-8">Ready to Face the Real Odds?</h2>
            <p className="text-xl mb-10">Start your simulation today and get data-driven insights about your gambling habits.</p>
            <Link href="/dashboard">
              <Button size="lg" className="bg-emerald-500 hover:bg-emerald-600 text-white font-bold py-3 px-8 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg">
                Create Your First Simulation <ChevronRight className="ml-2 h-5 w-5" />
              </Button>
            </Link>
          </div>
        </section>
        ...
        <footer className="py-10 px-4 sm:px-6 lg:px-8 bg-gray-900 border-t border-gray-800">
          <div className="max-w-7xl mx-auto text-center text-gray-400">
            <p>© {new Date().getFullYear()} Jackpot Awareness. All rights reserved.</p>
            <p className="mt-2">This tool is for educational purposes only. Gambling involves risk and can be addictive.</p>
          </div>
        </footer>
      </main>
    </>
